...
public @interface CodeBuilderRequest {
    ...
    Class<? extends Enricher>[] enrichers() default {ValidationEnricher.class, ModifierEnricher.class, CreatorModifierEnricher.class, OpenApiEnricher.class, JacksonEnricher.class, RegionEnricher.class};
